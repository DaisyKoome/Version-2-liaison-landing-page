...
<head>
 ...
 <section class="wrapper">
        ...
        <section class="banner-elements">
			<img src="<?php echo get_template_directory_uri(); ?>/images/banner-resized.png" class="banner-deskie mySlides">
            <img src="<?php echo get_template_directory_uri(); ?>/images/banner-resized.png" class="banner-deskie mySlides">
            <div class="items">
...
<!--                 <span class="icon-cheveron-left two"></span>                
				...
				<button class="icon-cheveron-right" id="slide1two" onclick="plusDivs(-1)"></button>
            </div>
        </section>
		...
		<section class="f-sec2">
            ...
            <footer class="footer2" style="background-color:#009fe0;">
                ...
                <p class="subscribe2">Email Address <span class="asterisk">*</span></p>
			<div class="banner-blue-rec f2">
					<?php echo do_shortcode( '[forminator_form id="988"]' ); ?>     
            </div>
                <br>
                <p class="privacy2">LIAISON GROUP  respects your privacy. No spam!</p>
                <p class="contacts-p2 one">Need more info? Contact us on:</p>
                <br>
                <p class="contacts-p2 two">Email: <a href="mailto:info@liaisongroup.net">info@liaisongroup.net</a></p>
                <br>
                <p class="contacts-p2 three">Phone number: (254) 703 071 000</p>
				<a href="#" class="contacts-p2 four">About Us</a>
                <br>
                <a href="#" class="contacts-p2 five">Terms & Conditions </a>

                    <p class="contacts-p2 six"><a href="mailto:info@liaisongroup.net">info@liaisongroup.net</a></p>
                    <br>
                    <p class="contacts-p2 seven"><a href="mailto:liaisongroup.net">liaisongroup.net</a></p>
                    <p class="weekdays2">Mon – Fri: 9am To 6pm</p>
                    <a href="https://twitter.com/LiaisonGroup"><span class="contacts-p2 icon-twitter eight"></span></a>
                    <a href="https://www.facebook.com/LiaisonGroupLtd/"><span class="contacts-p2 icon-facebook nine"></span></a>
                    <a href="https://www.instagram.com/LiaisonGroupLtd/"><span class="contacts-p2 icon-instagram ten"></span></a>
                    <br>
                    <span class="contacts-p2 eleven">
                    Copyright Liaison Group 2022. All rights reserved.
                    </span>
                </div>
...
/* 	@media only screen and (max-width: 600px) {
 .show-mobile{
  ...
  .hide-mobile{
	...
	.alt-footer p, .alt-footer span, .alt-footer ul li{
	...
	.alt-footer #forminator-module-988{
		    position: absolute;
    /* width: 100%; */
    /* text-align: center; */
    left: 30px;
